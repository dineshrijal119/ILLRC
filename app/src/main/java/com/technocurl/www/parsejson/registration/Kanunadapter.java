 ...
 */
public class Kanunadapter extends ArrayAdapter<Kanunichoosemode> {
    Choosepackage choosepackage;

    public Kanunadapter(Context context, ArrayList<Kanunichoosemode> users,Choosepackage choosepackage) {

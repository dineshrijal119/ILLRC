...
public class Tathyadetails extends AppCompatActivity {
    ...
    TextView details_najir_tathya,related_tipanni;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        related_tipanni=(TextView)findViewById(R.id.related_tipanni);
        ...
        new getThyadetailsnajir(id).execute();
        related_tipanni.setText(myList.get(0).getTippani());
//        new relatedtippani(id).execute();
    }

public   class relatedtippani extends AsyncTask<String,String,String>{
    String id;
    public relatedtippani(String id){
        this.id=id;
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            Log.d("dinesh", "thya tipanni post  : " + jsonObject);
            suchi_list = httpUrlConnectionJson.sendHTTPData(Constants.TIPANI_BY_THATHYA, jsonObject);
            Log.d("dinesh", "thya tipanni response : " + suchi_list);
    ...
    public class getThyadetailsnajir extends AsyncTask<String, String, String> {
        String id;
        public getThyadetailsnajir(String id){
            this.id=id;
        }

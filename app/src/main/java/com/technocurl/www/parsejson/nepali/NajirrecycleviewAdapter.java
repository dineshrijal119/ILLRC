...
public class NajirrecycleviewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NajirrecycleviewAdapter(Context context, List<NajirNepalimodel> data){

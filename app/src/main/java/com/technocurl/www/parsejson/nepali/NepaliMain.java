 ...
 */
public class NepaliMain extends AppCompatActivity {
    Toolbar toolbar;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle("नजीर (Nepali)");
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(NepaliMain.this, MainPage.class));
                finish();
            }
        });
   ...
   /* @Nullable
    ...
    public class  PagerAdapter extends FragmentStatePagerAdapter {
        ...
        int nNumberTabs;
        private String tabTitles[] = new String[]{"समान्य खोज","बिस्तृत खोज"};
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    return  new NajirNepaliSamanya();


                case 1:

                    return new NajirNepaliBistrti();

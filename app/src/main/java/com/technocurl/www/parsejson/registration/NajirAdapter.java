 ...
 */
public class NajirAdapter extends ArrayAdapter<Najirchoosmodel> {
    Choosepackage choosepackage;
    Context context;


    public NajirAdapter(Context context, ArrayList<Najirchoosmodel> users,Choosepackage choosepackage) {

 ...
 */
public class DetailsrowlistActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.najir_rsult_general);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DetailsrowlistActivity.this,NepaliMain.class));
            }
        });
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(DetailsrowlistActivity.this, Detailsrow.class);
...
public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    private DetailsrowlistActivity.ClickListener clickListener;

    public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final DetailsrowlistActivity.ClickListener clickListener) {
